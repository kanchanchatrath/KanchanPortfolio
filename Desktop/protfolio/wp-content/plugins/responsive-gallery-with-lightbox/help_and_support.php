<div>
    <center><h2 class="head_title"><?php _e( 'Responsive Gallery With Lightbox', WRGF_TEXT_DOMAIN ); ?></h2></center>
    <center>
...
<div style="margin-top:30px;margin-left:30px;">
    <h2 style="font-weight: bold;font-size: 28px;padding-top:10px;"><?php _e( 'Change Old Server Image URL', WRGF_TEXT_DOMAIN ); ?></h2>
    <form action="" method="post">
        <input type="submit" value="Change image URL" name="wrgfchangeurl"
               style="margin-top:10px; margin-right:10px; margin-left:30px; background:#31B0D5; text-decoration:none;"
               class="btn btn-primary btn-lg">

        <h6 style="font-size: 22px;padding-top: 10px;padding-bottom: 10px;line-height:40px"><b><?php _e( 'Note', WRGF_TEXT_DOMAIN ); ?>&nbsp;:&nbsp;</b><?php _e( 'Use this option after import', WRGF_TEXT_DOMAIN ); ?><b>Responsive Gallery</b> <?php _e( 'to change old server image url to new server image url', WRGF_TEXT_DOMAIN ); ?>.
        </h6>
    </form>
</div>
